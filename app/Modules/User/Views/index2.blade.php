                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false">
                        @if ($user->hasUnseenNotifications())
                            ...
                            <span class="notifications-count">{{$user->notifications()->count()}}</span>
                        @else
                            <i class="fa fa-bell text-gradient-danger"></i>
                        @endif
                    </a>
                    <ul class="dropdown-menu notify-drop">
                        @foreach($user->unseenNotifications() as $notification)
                            <li>
                                <a href="{{route('showdevice1', $notification->device_id)}}">
                                    @if ($notification->isBad())
                                        <i class="fa text-danger fa-exclamation-triangle"></i>
                                    @else
                                        <i class="fa text-primary fa-check-circle"></i>
                                    @endif
                ...
                <li class="nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="{{route("showinbox")}}">
                            <li class="dropdown-item"></i> Inbox</li>
                        </a>
                        <li class="dropdown-divider"></li>
                        <a href="{{route("showEditUser",['id' => $user->id])}}">
                            <li class="dropdown-item"><i class="icon-user mr-2"></i> My Profile</li>
                        </a>
                        <li class="dropdown-divider"></li>
                        <li class="dropdown-item"><i class="icon-power mr-2"></i><a href="{{route('handleLogout')}}"
            ...
            <div class="container-fluid">
                ...
                <div class="row mt-3">
                    @foreach($sites as $site)
                        <a href="{{route('showListSiteDevise', $site->id)}}" class="col-12 col-lg-6 col-xl-3">
                            <div
                                class="card stretched-link @if($site->hasBadNotification()) gradient-orange-2 @else gradient-ohhappiness @endif">
                                <div class="card-body">
                                    <h5 class="text-white mb-0">{{$site->name}}<span class="float-right"><i
                                                class="fa fa-eye"></i></span></h5>
                                    <p class="mb-0 text-white small-font">Notifications<span
                                            class="float-right">{{$site->unseenNotifications()->count()}}</span></p>
                                    @if ($site->hasNotification())
                                        <p class="mt-2 text-white small-font">
                                            @if ($site->lastNotification()->isBad())
                                                <i class="fa fa-exclamation-triangle"></i>
                                            @else
                                                <i class="fa fa-check-circle"></i>
                                            @endif
                                            {{$site->lastNotification()->message}}
                                        </p>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="col-12 col-lg-12 col-xl-16">
                    <div class="card">
                        <div class="card-header text-center">World Selling Region
                        </div>
                            ...
                            <div id="dashboard-map" style="height: 275px;">
                                <div class="jvectormap-container" style="background-color: transparent;">
                                    <svg width="400" height="275">
                                        <defs></defs>
                                        <g transform="scale(0.4444444444444444) translate(0, 89.02184462793355)">
                                            <path
                                                ...
                                                data-code="BD" fill="#14abef" fill-opacity="1" stroke="none"
                                            ...
                                            <path
                                                ...
                                                data-code="BE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BF" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BG" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M707.48,273.58l0.68,-0.65l1.41,-0.91l-0.15,1.63l-0.81,-0.05l-0.61,0.58l-0.53,-0.6Z"
                                                data-code="BN" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BO" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="JP" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M495.45,295.49l-1.08,-2.99l1.14,-0.11l0.64,-1.19l0.76,0.09l0.65,1.83l-2.1,2.36Z"
                                                data-code="BI" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="BW" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            ...
                                            <path
                                                ...
                                                data-code="BS" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BY" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M198.03,244.38l0.1,-4.49l0.69,-0.06l0.74,-1.3l0.34,0.28l-0.4,1.3l0.17,0.58l-0.34,2.25l-1.3,1.42Z"
                                                data-code="BZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="RS" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LT" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path d="M436.08,149.45l-0.48,-0.07l0.3,-1.28l0.27,0.4l-0.09,0.96Z"
                                                  data-code="LU" fill="#14abef" fill-opacity="1" stroke="none"
                                                  stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="RO" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GW" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GT" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path d="M448.79,279.62l0.02,2.22l-4.09,0.0l0.69,-2.27l3.38,0.05Z"
                                                  data-code="GQ" fill="#14abef" fill-opacity="1" stroke="none"
                                                  stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GY" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GB" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="GM" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GL" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element" cursor="pointer"></path>
                                            <path
                                                d="M540.81,207.91l0.37,0.86l-0.17,0.76l0.6,1.53l-0.95,0.04l-0.82,-1.28l-1.57,-0.18l1.31,-1.88l1.22,0.17Z"
                                                data-code="KW" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GH" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="JO" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="HR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="HT" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="HU" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="PT" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PY" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PG" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PK" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PH" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PL" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path d="M504.91,192.87l0.34,0.01l0.27,-0.07l-0.29,0.26l-0.31,-0.2Z"
                                                  data-code="-99" fill="#14abef" fill-opacity="1" stroke="none"
                                                  stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ZM" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EH" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element" cursor="pointer"></path>
                                            <path
                                                ...
                                                data-code="EE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EG" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ZA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EC" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AL" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AO" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="KZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="ES" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ER" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M468.91,172.53l-1.22,-1.02l0.47,-1.81l0.89,-0.72l2.26,1.51l-0.5,0.57l-0.75,-0.27l-1.14,1.73Z"
                                                data-code="ME" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MD" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MG" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="UZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MM" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ML" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MN" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element" cursor="pointer"></path>
                                            <path
                                                ...
                                                data-code="MK" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MW" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element" cursor="pointer"></path>
                                            <path
                                                ...
                                                data-code="UG" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MY" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MX" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path d="M839.04,322.8l0.22,1.14l-0.44,0.03l-0.2,-1.45l0.42,0.27Z"
                                                  data-code="VU" fill="#14abef" fill-opacity="1" stroke="none"
                                                  stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="FJ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="FK" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NI" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NL" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NO" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M838.78,341.24l-0.33,0.22l-2.9,-1.75l-3.26,-3.37l1.65,0.83l4.85,4.07Z"
                                                data-code="NC" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NG" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NP" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CI" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CH" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CO" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CN" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CM" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CL" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element" cursor="pointer"></path>
                                            <path
                                                ...
                                                data-code="CG" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CF" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CD" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M504.36,193.47l0.43,0.28l-1.28,0.57l-0.92,-0.28l-0.24,-0.46l2.01,-0.13Z"
                                                data-code="CY" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CU" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M500.35,351.36l0.5,2.04l-0.38,0.89l-1.05,0.21l-1.23,-1.2l-0.02,-0.64l0.83,-1.57l1.34,0.27Z"
                                                data-code="SZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SY" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="SS" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="KH" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M195.8,250.13l1.4,-1.19l2.24,1.45l0.98,-0.27l0.44,0.2l-0.27,1.05l-1.14,-0.03l-3.64,-1.21Z"
                                                data-code="SV" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SK" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="KR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="SO" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SN" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SL" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SB" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SD" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DO" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DJ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DK" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element" cursor="pointer"></path>
                                            <path
                                                ...
                                                data-code="YE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AT" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="US" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LV" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="UY" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M510.37,198.01l-0.88,0.51l1.82,-3.54l0.62,0.08l0.22,0.61l-1.13,0.88l-0.65,1.47Z"
                                                data-code="LB" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M724.01,226.68l-0.74,1.48l-0.9,-1.52l-0.25,-1.74l1.38,-2.44l1.73,-1.74l0.64,0.44l-1.85,5.52Z"
                                                data-code="TW" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path d="M266.64,259.32l0.28,-1.16l1.13,-0.22l-0.06,1.2l-1.35,0.18Z"
                                                  data-code="TT" fill="#14abef" fill-opacity="1" stroke="none"
                                                  stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="TM" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TJ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M491.06,363.48l-0.49,0.15l-1.49,-1.67l1.1,-1.43l2.19,-1.44l1.51,1.27l-0.98,1.82l-1.23,0.38l-0.62,0.93Z"
                                                data-code="LS" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TH" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M596.68,420.38l-3.2,0.18l-0.05,-1.26l0.39,-1.41l1.3,0.78l2.08,0.35l-0.52,1.36Z"
                                                data-code="TF" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TG" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TD" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LY" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="VE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element" cursor="pointer"></path>
                                            <path
                                                ...
                                                data-code="AF" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IQ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IS" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AM" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IT" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="VN" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AR" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AU" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IL" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IN" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IE" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ID" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="UA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M549.33,221.64l-0.76,-0.23l-0.14,-1.64l0.84,-1.29l0.47,0.52l0.04,1.34l-0.45,1.3Z"
                                                data-code="QA" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MZ" fill="#14abef" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                        </g>
                                        <g></g>
                                        <g>
                                            <circle data-index="0" cx="273.8966031280289" cy="142.47107567493117"
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$site->devises()->count()}}</td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-header border-0">List devices
                            </div>
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush">
                                    ...
                                    @foreach($devises as $devise)
                                        ...
                                        <tr>
                                            <td>{{$devise->id}}</td>
                                            <td>{{$devise->name_device}}</td>
                                            <td>{{$devise->site->name}}</td>
                                            <td>{{$devise->site->localisation}}</td>
                                            <td>
                                                <span class="badge-dot">
                                                    <i class="@if($devise->isWorking()) bg-success @else bg-danger @endif"></i>
                                                    {{$devise->status}}
                                                </span>
                                            </td>
