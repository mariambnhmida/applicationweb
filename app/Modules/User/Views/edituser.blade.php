                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form action ="{{route('handleedituser', ['id' =>$users->id])}}" method="post"  onsubmit="return Validate()" name="vform">
                                {{csrf_field()}}
                                <br>
                                <div class="form-group">
                                    <label for="exampleEmail11" class="">Email</label>
                                    <input name="email" id="exampleEmail11" placeholder="Email" type="Email" value="{{$users->email}}" class="form-control"></div>

                                <div class="form-group">
                                    <label for="examplePassword11" class="">Password</label>
                                    <input name="password" id="examplePassword11" placeholder="Password " type="password" class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="examplePassword11" class="">Confirm Password</label>
                                    <input name="password_confirmation" id="examplePassword11" placeholder="CHECK YOUR PASSWORD " type="password" class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="exampleEmail11" class="">First Name</label>
                                    <input name="nom" id="exampleEmail11" placeholder="First Name" type="nom" value="{{$users->nom}} "class="form-control" required>
                                </div>

                                <div class="form-group">
                                    <label for="examplePassword11" class="">Last Name</label>
                                    <input name="prenom" id="examplePassword11" placeholder="Last Name" type="prenom" value="{{$users->prenom}}" class="form-control" required>
                                </div>

                                  <div class="form-group">
                                      <div class="position-relative form-group"><label for="exampleCity" class="">Adress</label>
                                          <input name="adresse" id="exampleCity" placeholder="adresse" type="adresse" value="{{$users->adresse}} " class="form-control" required>
                                      </div>
                                  </div>

                                <div class="position-relative form-group ">
                                    <label for="exampleState" class="">Country</label>
                                    <select class="form-control  col-md-12" name="pays" id="pays"value="{{$users->pays}}">
                                ...
                                <div class="form-group">
                                    <label for="exampleZip" class="">Phone</label>
                                    <input name="tel" id="tel" placeholder="Your phone" type="tel" value="{{$users->tel}}" class="form-control" required>
                                    </div>
                                <div class="form-group">
                                    ...
                                    <select name="site_id" id="site_id" class="form-control "  >
                                        ...
                                        @foreach($sites as $site)
                                            <option @if($user->site_id == $site->id) selected @endif value="{{$site->id}}">{{$site->name}}</option>
                                        @endforeach
