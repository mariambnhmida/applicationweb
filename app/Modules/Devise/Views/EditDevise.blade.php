            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="page-title">Update Device</h4>

                            <hr>

                            <form action ="{{route('handleeditdevise', ['id' =>$devises->id])}}" method="post">
                                {{csrf_field()}}
                                <br>
                                <div class="form-group">
                                    <label for="exampleEmail11" class=""> Name Device</label>
                                    <input name="name_device"  placeholder="Name Device" type="text" class="form-control"  value="{{$devises->name_device}} " required>
                                </div>

                                <div class="form-group">
                                    <label for="exampleEmail11" class=""> Mac Adress</label>
                                    <input name="id_mac"  placeholder="Enter your Mac Adress" type="text" class="form-control"  value="{{$devises->id_mac}} " required>
                                </div>

                                <div class="form-group">
                                    <label for="exampleEmail11" class=""> Timeout</label>
                                    <input name="timeout"  placeholder="Timeout in seconds" type="number" step="1" class="form-control"  value="{{$devises->timeout}}" required>
                                </div>

                                <div class="form-group">
                                    <label for="examplePassword11" class="">Site</label>
                                    <select name="site_id" id="site_id" class="form-control " value="{{$devises->site_id}}">
