            ...
            <ul class="navbar-nav align-items-center right-nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="{{route("showEditUser",['id' => Auth::user()->id])}}">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="page-title">Settings threshold</h4>
                            ...
                            @endif
                            <form class="main-card mb-3 card"
                                  action="{{route('handleEditSettingsDevise',['id' => $devises->id])}}" method="post">
                                {{csrf_field()}}
                                <br>

                                <div class="form-group">
                                    <label for="examplePassword11" class="">Settings threshold </label>
                                    <select name="name" id="name" class="form-control ">
                                        <option value="">Select threshold
                                        </option>
                                        <option value="PH">PH</option>
                                        <option value="ORP">ORP</option>
                                        <option value="water temprature">water temprature</option>
                                        <option value="air temprature">air temprature</option>
                                        <option value="ppm">ppm</option>
                                        {{--<option value="Flotteur1" >Flotteur1 </option>--}}
                                        {{--<option value="Flotteur2" >Flotteur2 </option>--}}
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="examplePassword11" class="">Minimum value
                                    </label><input name="Up" id="exampleCity" placeholder="Enter your value" type="Up"
                                                   class="form-control" required></div>
                                <br/>


                                <div class="form-group">
                                    <label for="examplePassword11" class="">Maximum value
                                    </label><input name="Down" id="exampleCity" placeholder="Enter your value"
                                                   type="Down" class="form-control" required></div>
                                <br/>


                                <div class="form-group text-center">
                                    <div class="form-footer">
                                        <a href="{{route('showlistdevise2')}}">
                                            <button type="submit" class="btn btn-success"><i
                                                    class="fa fa-check-square-o"></i> Validate
                                            </button>
                                        </a></div>
                                </div>
                            </form>
                            ...
                            <div class="form-group text-center">
                                <div class="form-footer">
                                    <a href="{{route('showlistuser')}}">
                                        ...
                                        <button type="submit" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL
                                        </button>
                                    </a>
                                </div>
                            </div>
