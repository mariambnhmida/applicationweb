                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{route('handelCreateDevise')}}" method="post" class="">
                                {{csrf_field()}}
                                <br>      <div class="form-group">
                                    <label for="name_device" class="">Name Device</label>
                                    <input name="name_device"  placeholder="Name Device" type="text" class="form-control"required>
                                </div>

                                <div class="form-group">
                                    <label for="id_mac" class=""> Mac Adress</label>
                                    <input name="id_mac" id="id_mac"  placeholder="FF : FF : FF : FF : FF : FF" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="id_mac" class=""> Timeout</label>
                                    <input name="timeout" id="timeout"  placeholder="Timeout in seconds" type="number" class="form-control" required>
                                </div>
                                <div class="form-group">
